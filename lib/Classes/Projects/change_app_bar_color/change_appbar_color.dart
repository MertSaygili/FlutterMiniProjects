...
class _ChangeAppBarColorState extends State<ChangeAppBarColor> {
  ...
  SizedBox _setElevatedButton(Color color, String text) {
    return SizedBox(
      width: SizedBoxSettings()._widthWide,
...
class PaddingSettings {
  final EdgeInsets paddingPage = EdgeInsets.symmetric(
      vertical: PaddingItems()._normalVertical,
      horizontal: PaddingItems()._normalHorizontal);
}

class PaddingItems {
  final double _normalVertical = 55;
  final double _normalHorizontal = 10;
}

class SizedBoxSettings {
  final double _widthWide = 400;
}
